...
if ( !@mysql_select_db( DB_NAME, $dbh ) ) {
	...
	$query = "SELECT wp_posts.* FROM wp_posts WHERE wp_posts.post_type = 'donate_goods' AND (wp_posts.post_status = 'publish' OR wp_posts.post_status = 'private') AND wp_posts.post_date > '".$yesterday." 00:00:00' AND wp_posts.post_date < '".$today." 00:00:00'";
	...
	$bodyContent .= "Here is your Daily Report for the Donate Goods section of your website <br/>";
	...
	$mail->AddAddress('asalazar@midnightmission.org', 'Ana Salazar');
	//$mail->AddAddress('chris@liquidmindcreative.com');
	//$mail->AddAddress('cann@liquidmindcreative.com');
	

	$mail->Subject = '[Midnight Mission] Donate Goods Daily Report '. $yesterday;
	if($numberItems == 1) {
