...
<div id="main" class="group">
	...
	<div id="blog" class="right-col archives">
		...
		<div id="blog-ctn">
			...
			?>
			<a href="<?php echo $page_blog_link ?>" class="blog-back">Back to
				list</a>
			...
			<div class="cnt-man">
				<div class="blog-list">
					<div class="blog-sub">
						<?php echo getBlog() ?>
						<div id="share-options" class="blog-cnt-1">
							...
							<div class="blog-share-1">
								...
								<ul>
									<li class="sh-text">SHARE:</li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_1.png" /> </a></li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_2.png" /> </a></li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_3.png" /> </a></li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_4.png" /> </a></li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_5.png" /> </a></li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_6.png" /> </a></li>
									<li><a href="#"><img alt=""
											src="<?php echo IMAGES ?>/blog_icon_7.png" /> </a></li>
								</ul>
								 -->
							</div>
						</div>
